...
<head>
	...
	<meta charset="utf-8">
	<meta name="keywords" content="vMundus, virtual world, new world, micronations">
	<meta name="author" content="vMundus">
	<meta name="copyright" content="vMundus">
	<meta name="name" content="vMundus - World of Nations and Micronations| <?php echo $lang['meta_name']; ?>">
	<meta name="description" content="<?php echo $lang['meta_description']; ?>">
	<title>vMundus - World of Nations and Micronations</title>
		...
		<div id="stat_div">
			...
			<?php  
				...
				$query = "SELECT flag, country_name, SUM(productivity * price)/(SELECT price FROM product_price WHERE product_id = 1) 
						  ...
						  GROUP BY r.country_id ORDER BY prod_in_gold DESC LIMIT 10";
				$result = $conn->query($query);
				while($row = $result->fetch_row()) {
				...
				$query = "SELECT flag, country_name, SUM(damage_bonus + 10 + (level * 0.02)) *
						 (SELECT energy/10 FROM energy_consumption WHERE cons_id = 2) AS user_total_damage 
						  ...
						  GROUP BY citizenship ORDER BY user_total_damage DESC LIMIT 5";
				$result = $conn->query($query);
				while($row = $result->fetch_row()) {
				...
				$query = "SELECT flag, country_name, COUNT(r.country_id) AS total_regions 
						  ...
						  GROUP BY r.country_id ORDER BY total_regions DESC LIMIT 10";
				$result = $conn->query($query);
				while($row = $result->fetch_row()) {
	...
	<div id="desc_div">
		<div id="desc_div_desc">
			...
			<ul id="general_ul">
				...
				<li>1 Alien <?php echo $lang['country']; ?></li>
...
<footer>
	<div id="footer_elements">
		...
		<div id="fe_col2">
			...
			<p id="fe_col2_email">vmundus.online@gmail.com</p>
	...
	<p id="allrr">All Rights Reserved. &copy; 2021-<?php echo date('Y'); ?></p>

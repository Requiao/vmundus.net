<?php
	...
	$lang = array(
		...
		"congress"=>"Kongre",
		"country_abbreviation"=>"Ülke kısaltması",
		"country_currency"=>"Ülke Para Birimi",
		"country_population_graph"=>"Country Population Graph",
		"country_products"=>"Ülke Ürünleri",
		"country_resources"=>"Ülke Kaynakları",
		"currency"=>"Para birimi",
		"current_population"=>"Current Population",
		"daily_income_from_taxes"=>"Vergilerden günlük gelir",
		"daily_income_in_gold_from_production_taxes"=>"Daily income in Gold from Production taxes",
		"day"=>"Day",
		"days"=>"days",
		"days_left"=>" days left",
		"defense_agreements"=>"Savunma Anlaşmaları",
		"defense_system"=>"Savunma Sistemi",
		...
		"government"=>"Devlet",
		"government_term_length"=>"Hükümet Süre Uzunluğu",
		...
		"member_of_the_union"=>"Birliğin üyesi",
		...
		"persons_life_expectancy"=>"Kişinin yaşam beklentisi",
		"politics"=>"Siyaset",
		"population_change_graph"=>"Nüfus Değişim Grafiği:",
		"regions"=>"Bölgeler",
		"region_resources"=>"Region resources bonus",
		"research"=>"Araştırma",
		"salary"=>"salary:",
		"taxes_for_foreigners_to_build_a_company"=>"Taxes for foreigners to build a Company",
		"taxes_on_import"=>"İthalat vergileri",
		"taxes_on_production"=>"Üretim Vergileri",
		"taxes_on_product_sale"=>"Ürün satış vergileri",
		...
		"countries_map"=>"Ülkeler Haritası",
		"country"=>"Ülke",
		...
		"military"=>"Askeri",
		"parties"=>"Partiler",
		"party_info"=>"Benim partim",
		"players"=>"Players",
		"politics"=>"Politics",
		"presidential_elections"=>"Cumhurbaşkanlığı Seçimleri",
		"product_market"=>"Ürün Pazarı",
		"product_price_status"=>"Product Price Status",
		"social"=>"Sosyal",
		"statistics"=>"İstatistik",
		"store"=>"Store",
		"unions"=>"İttifak",
		"unions_map"=>"Birlikler Haritası",
		"union_info"=>"Sendika Bilgisi",
		"warehouse"=>"Depo",
		"work"=>"İş",
		"people"=>"Insanlar",
        "micronations"=>"Mikronasyonlar",
		//companies page

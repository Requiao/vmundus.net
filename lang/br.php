<?php
	...
	$lang = array(
		...
		//messages
		"choose_at_least_one_mail_to_delete"=>"Selecciona pelo menos uma mensagem para apagar",
		"compose_message"=>"Compor Mensagem",
		"delete"=>"Apagar",
		"deleted"=>"Apagado",
		"messages"=>"Mensagens",
		"messages_successfully_deleted"=>"Mensagens apagadas com sucesso",
		"notifications"=>"Notificações",
		"other_member_deleted_this_conversation"=>"O outro membro apagou esta conversa",
		
		//user_profile
		"accepted_your_citizenship_request"=>" aceitou o seu pedido de amizade.",
		...
		"compose_message"=>"Compor Mensagem",
		"currency"=>"Moeda",
		"days_in_game"=>" dias no jogo",
		"do_you_want_to_cancel_this_application"=>"Do you want to cancel this application?",
		"friends"=>"Amigos",
		"friendship_request_sent"=>"Pedido de Amizade enviado.",
		"hard_worker_progress"=>"Progresso do Trabalho Duro",
		"heading"=>"Heading",
		...
		//country
		"active_players"=>"Cidadãos Ativos",
		"active_wars"=>"Guerras Ativas",
		...
		"congress"=>"Congresso",
		"country_abbreviation"=>"Abreviação do País (Sigla)",
		"country_currency"=>"Moeda Oficial",
		"country_population_graph"=>"Gráfico do Crescimento Populacional",
		"country_products"=>"Produtos do País",
		"country_resources"=>"Recursos do País",
		"currency"=>"Moeda Oficial",
		"current_population"=>"População Atual",
		"daily_income_from_taxes"=>"Renda Diária de Impostos (Em Ouro)",
		"daily_income_in_gold_from_production_taxes"=>"Renda Diária de Impostos de Produção (Em Ouro)",
		"day"=>"Dia",
		"days"=>"dias",
		"days_left"=>" days left",
		"defense_agreements"=>"Pactos de Defesa",
		"defense_system"=>"Sistema de Defesa",
		...
		"government"=>"Governo",
		"government_term_length"=>"Duração do Mandato do Governo",
		"importing_products_into_this_country_is_not_allowed"=>"A importação de produtos para este país não é permitida.",
		"import_taxes"=>"Impostos de Importação",
		"income_tax"=>"Imposto de Renda",
		"law_history"=>"Histórico de Leis",
		"member_of_the_union"=>"Membro da Aliança",
		"nationality"=>"Nacionalidade",
		"new_people"=>"Novas Pessoas",
		"new_players"=>"Novos Cidadãos",
		"nobody_can_enter_this_country"=>"Ninguém pode entrar neste país.",
		"on_duty_since_day"=>"On duty since day:",
		"on_duty_until_day"=>"On duty until day:",
		"passed_away_people"=>"Pessoas Falecidas",
		"people_located_in_the_country"=>"Pessoas localizadas no país",
		"persons_life_expectancy"=>"Expectativa de vida das pessoas",
		"politics"=>"Políticas",
		"population_change_graph"=>"Gráfico de Mudança Populacional:",
		"regions"=>"Regiões",
		"region_resources"=>"Recursos da Região",
		"research"=>"Pesquisa",
		"salary"=>"salário:",
		"taxes_for_foreigners_to_build_a_company"=>"Taxa para estrangeio contruir Empresa.",
		"taxes_on_import"=>"Impostos de Importação",
		"taxes_on_production"=>"Impostos de Produção",
		"taxes_on_product_sale"=>"Impostos de Venda de Produtos",
		"taxes_to_build_a_company"=>"Imposto de Construção de Empresa",
		"this_country_has_no_allies"=>"Este País Não Possui Aliados.",
		"this_country_is_peaceful"=>"Este País é Pacífico!",
		...
		"company_upgraded"=>"Empresa ampliada",
		...
		"production"=>"Produção",
		"production_per_worker"=>"Produtividade por trablhador",
		"production_tax"=>"Imposto de Produção",
		"products_in_the_quantity_of"=>"Products in the quantity of ",
		"products_successfully_invested"=>"Products successfully invested",
		"product_storage"=>"Estoque de Produtos",
		"quantity"=>"Quantidade",
		...
		"resources_required_per_one_worker"=>"Recursos necessários por um trabalhador",
		"resource_storage"=>"Estoque de Recursos",
		"salary"=>"Salário",
		"salary_level_must_be_in_the_range"=>"Salary level must be in the range ",
		"salary_successfully_changed"=>"Salário alterado corretamente",
		"sell"=>"Vender",
		"selling"=>"Vendendo",
		"skill"=>"Skill",
		...
		"tax"=>"Taxa",
		"this_company_is_already_on_the_market"=>"Esta empresa já está a venda!",
		"this_company_is_not_on_the_market"=>"Esta empresa não está a venda.",
		"upgrade"=>"Ampliar",
		...
		"you_dont_have_enough"=>"Você não possui ",
		...
		//home
		"active_battles"=>"Batalhas Ativas",
		"blogs"=>"Jornais",
		"calculator"=>"Calculadora",
		"people"=>"Pessoas",
		"chat"=>"Chat",
		"companies"=>"Empresas",
		"company_market"=>"Mercado de Empresas",
		"corporations"=>"Corporações",
		"countries_map"=>"Mapa Politico",
		"country"=>"País",
		"country_order"=>"Ordem Militar",
		"currency_exchange"=>"Trocas de Moeda",
		"economy"=>"Economia",
		"elections"=>"Eleições",
		"elections_to_congress"=>"Eleições para o Parlamento",
		"game_updates"=>"Novidades",
		"gold_market"=>"Mercado de Ouro",
		"houses"=>"Casas",
		"job_offers"=>"Ofertas de Emprego",
		"join_attacker"=>"Atacar",
		"join_defender"=>"Defender",
		"map"=>"Mapas",
		"military"=>"Exército",
		"parties"=>"Partidos do País",
		"party_info"=>"Meu Partido",
		"players"=>"Jogadores",
		"politics"=>"Politica",
		"presidential_elections"=>"Eleições Presidenciais",
		"product_market"=>"Mercado de Produtores",
		"product_price_status"=>"Estado do Preço do Produto",
		"social"=>"Social",
		"statistics"=>"Estatísticas",
		"store"=>"Loja",
		"unions"=>"Alianças",
		"unions_map"=>"Mapa de Alianças",
		"union_info"=>"Aliança do Meu País",
		"warehouse"=>"Armazém",
		"work"=>"Trabalho",
		"micronations"=>"Micronações",
		
		//companies page
		"available_resources_for_working_cycles"=>"Recursos disponíveis para N ciclos de trabalho",
		"building_doesnt_exists"=>"Construção não existe",
		"building_name"=>"Nome do Edifício",
		"cancel"=>"Cancelar",
		"collect_all_products"=>"Coletar produtos",
		"companies"=>"Empresas",
		"companies_are_not_movable"=>"Empresas não são moveis",
		"company_created"=>"Empresa criada",
		"company_name"=>"Nome da Empresa",
		"corporation_doesnt_exist"=>"Corporação não existe",
		"country"=>"País",
		"country_name"=>"Nome do País",
		"create"=>"Criar",
		"create_company"=>"Criar Empresa",
		"default"=>"Padrão",
		"invalid_sorting_option"=>"Opção de ordenação invalida",
		"items"=>"Itens",
		"manage"=>"Gerir",
		"name"=>"Nome",
		"not_hired"=>"Não contratado",
		"not_worked"=>"Não trabalhou",
		"no_products_available_to_collect"=>"Sem produtos disponíveis para recolher",
		"price"=>"Preço",
		"product"=>"Produto",
		...
		"region"=>"Região",
		"region_doesnt_exists"=>"Região não existe",
		"region_name"=>"Nome da Região",
		"required"=>"Necessário",
		"resources_fill"=>"Alocação de Recursos",
		"sort_by"=>"Organizar",
		"storage_fill"=>"Encher Armazém",
		"successfully_collected"=>"Recolhido Corretamente",
		"this_country_has_not_researched_this_building"=>"Este país não desbloqueou esta construção",
		"this_region_doesnt_have_required_resource_for_this_company"=>"Esta região não tem os recursos necessários para esta Empresa",
		...
		"you_are_not_allowed_to_build_companies_in_this_country"=>"Não estás autorizado a abrir Empresas neste país",
		"you_are_not_allowed_to_build_this_company_in_this_country"=>"Não estás autorizado a abrir esse tipo de Empresa neste País",
		"you_dont_have_access_to_this_corporation"=>"Não tens acesso a esta Corporação",
		"you_dont_have_enough_gold"=>"Você não tem ouro suficiente",
		"you_dont_have_enough_resources"=>"Não tens recursos suficientes",
		"you_dont_own_any_company"=>"Não és dono de nenhuma Empresa",
		"you_need_space_for_at_least"=>"Tu precisas de espaço para no mínimo"
	);
?>
<?php
	...
	$lang = array(
		...
		"change_location_for_people"=>"Change location for civil People",
		...
		"congress"=>"Parlamento",
		"country_abbreviation"=>"Abreviatura del país",
		...
		"government"=>"Gobierno",
		"government_term_length"=>"Duración del mandato gubernamental",
		...
		"law_history"=>"Historia del Derecho",
		"member_of_the_union"=>"Miembro de la Alianza",
		"nationality"=>"Nacionalidad",
		"new_people"=>"Gente nueva",
		...
		"persons_life_expectancy"=>"Esperanza de vida de la persona",
		"politics"=>"Política",
		...
		"taxes_on_import"=>"Impuestos de importación",
		"taxes_on_production"=>"Impuestos sobre la producción",
		"taxes_on_product_sale"=>"Impuestos sobre la venta de productos",
		"taxes_to_build_a_company"=>"Impuestos para construir una empresa",
		"this_country_has_no_allies"=>"Este país no tiene aliados.",
		"this_country_is_peaceful"=>"Este país es pacífico.",
		...
		//home
		"active_battles"=>"Batallas activas",
		"blogs"=>"Blogs",
		"calculator"=>"Calculadora",
		"chat"=>"Chat",
		"companies"=>"Compañías",
		"company_market"=>"Mercado de Compañías",
		"corporations"=>"Corporaciones",
		"countries_map"=>"Mapa de países",
		"country"=>"País",
		"country_order"=>"Orden del país",
		"currency_exchange"=>"Intercambiar Moneda",
		"economy"=>"Economía",
		"elections"=>"Elecciones",
		"elections_to_congress"=>"Elecciones al congreso",
		"game_updates"=>"Actualizaciones del juego",
		"gold_market"=>"Mercado de oro",
		"people"=>"Personas",
		"job_offers"=>"Ofertas de Trabajo",
		"join_attacker"=>"Unirse al Atacante",
		"join_defender"=>"Unirse al Defensor",
		"map"=>"Mapa",
		"military"=>"Militar",
		"parties"=>"Partidos",
		"party_info"=>"Información del Partido",
		"players"=>"Jugadores",
		"politics"=>"Políticos",
		"presidential_elections"=>"Elecciones Presidenciales",
		"product_market"=>"Mercado Local",
		"product_price_status"=>"Precio de Mercado de Productos",
		"social"=>"Social",
		"statistics"=>"Estadísticas",
		"store"=>"Tienda",
		"unions"=>"Uniones",
		"unions_map"=>"Mapa de uniones",
		"union_info"=>"Información de la unión",
		"warehouse"=>"Almacén",
		"work"=>"Trabajar",
		"micronations"=>"Micronaciones",
		
		//companies page
		"available_resources_for_working_cycles"=>"Recursos disponibles para N ciclos de trabajo",
		"building_doesnt_exists"=>"El edificio no existe",
		"building_name"=>"Nombre del edificio",
		"cancel"=>"Cancelar",
		"collect_all_products"=>"Recoger Productos",
		"companies"=>"Compañías",
		"companies_are_not_movable"=>"Las compañías no se pueden mover",
		"company_created"=>"Compañía creada",
		"company_name"=>"Nombre de la compañía",
		"corporation_doesnt_exist"=>"La corporación no existe",
		"country"=>"País",
		"country_name"=>"Nombre del país",
		"create"=>"Crear",
		"create_company"=>"Crear compañía",
		"default"=>"Defecto",
		"invalid_sorting_option"=>"Opción de búsqueda no válida",
		"items"=>"Objetos",
		"manage"=>"Gestionar",
		"name"=>"Nombre",
		"not_hired"=>"No contratado",
		"not_worked"=>"No trabajado",
		"no_products_available_to_collect"=>"No hay productos para recolectar",
		"price"=>"Precio",
		"product"=>"Producto",
		...
		"region"=>"Región",
		"region_doesnt_exists"=>"Región inexistente",
		"region_name"=>"Nombre de la región",
		"required"=>"Requerido",
		"resources_fill"=>"Recursos llenan",
		"storage_fill"=>"Almacén productos",
		"sort_by"=>"Ordenar",
		"successfully_collected"=>"recolectado con éxito",
		"this_country_has_not_researched_this_building"=>"El país no ha investigato este edificio",
		"this_region_doesnt_have_required_resource_for_this_company"=>"Esta región no tiene el recurso necesario para esta compañía",
		...
		"worked"=>"Trabajado",
		"workers_details"=>"Detalles de trabajadores",
		"you_are_not_allowed_to_build_companies_in_this_country"=>"No puedes construir una compañía en este país",
		"you_are_not_allowed_to_build_this_company_in_this_country"=>"No puedes construir esta compañía en este país",
		"you_dont_have_access_to_this_corporation"=>"No tienes acceso a esta corporación",
		"you_dont_have_enough_gold"=>"No tienes suficiente oro",
		"you_dont_have_enough_resources"=>"No tienes suficientes recursos",
		"you_dont_own_any_company"=>"No posees una compañía",
		"you_need_space_for_at_least"=>"Necesitas espacio para como mínimo"
	);
?>
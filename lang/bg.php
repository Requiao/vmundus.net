<?php
	...
	$lang = array(
		...
		"congress"=>"Конгрес",
		"country_abbreviation"=>"Съкращение на държавата",
		"country_currency"=>"Валута на държавата",
		...
		"member_of_the_union"=>"Член на Алианса",
		...
		"countries_map"=>"Карта на страните",
		"country"=>"Държава",
		...
		"gold_market"=>"Златен пазар",
		 
		"job_offers"=>"Оферти за работа",
		"join_attacker"=>"Join Attacker",
		"join_defender"=>"Join Defender",
		"map"=>"Карта",
		"military"=>"Военен",
		"parties"=>"Политика на партиите",
		"party_info"=>"Моята политическа партия",
		"players"=>"Players",
		"politics"=>"Политика",

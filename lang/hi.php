<?php
	...
	$lang = array(
		...
		"congress"=>"Congress",
		"country_abbreviation"=>"देश का संक्षिप्त नाम",
		"country_currency"=>"देश की मुद्रा",
		...
		//home
		"active_battles"=>"सक्रिय युद्ध",
		"blogs"=>"ब्लॉग",
		"calculator"=>"कैलकुलेटर",
		"chat"=>"बातचीत",
		"companies"=>"कंपनियों",
		"company_market"=>"कंपनी मार्केट",
		"corporations"=>"निगमों",
		"countries_map"=>"देशों का नक्शा",
		"country"=>"देश",
		"country_order"=>"देश आदेश",
		"currency_exchange"=>"मुद्रा विनिमय",
		"economy"=>"अर्थव्यवस्था",
		"elections"=>"चुनाव",
		"elections_to_congress"=>"संसद के चुनाव",
		"game_updates"=>"खेल अपडेट",
		"gold_market"=>"गोल्ड मार्केट",
		"people"=>"लोग",
		"job_offers"=>"नौकरी के प्रस्ताव",
		"join_attacker"=>"आक्रमणकारी में शामिल हों",
		"join_defender"=>"डिफेंडर में शामिल हों",
		"map"=>"नक्शा",
		"military"=>"सैन्य",
		"parties"=>"राजनीतिक दलों",
		"party_info"=>"राजनीतिक दल की जानकारी",
		"players"=>"खिलाड़ियों",
		"politics"=>"राजनीति",
		"presidential_elections"=>"राष्ट्रपति का चुनाव",
		"product_market"=>"उत्पाद मार्केट",
		"product_price_status"=>"उत्पाद की कीमत स्थिति",
		"social"=>"सामाजिक",
		"statistics"=>"आंकड़े",
		"store"=>"दुकान",
		"unions"=>"यूनियन",
		"unions_map"=>"यूनियन नक्शा",
		"union_info"=>"यूनियन जानकारी",
		"warehouse"=>"गोदाम",
		"work"=>"काम",
		...
		"building_doesnt_exists"=>"इमारत मौजूद नहीं है",
		"building_name"=>"इमारत का नाम",
		"cancel"=>"रद्द करना",
		"collect_all_products"=>"सभी उत्पाद ले लीजिए",
		"companies"=>"कंपनियों",
		"companies_are_not_movable"=>"कंपनियां जंगम नहीं हैं",
		"company_created"=>"कंपनी बनाई गई",
		"company_name"=>"कंपनी का नाम",
		"corporation_doesnt_exist"=>"निगम मौजूद नहीं है",
		"country"=>"देश",
		"country_name"=>"देश का नाम",
		"create"=>"सर्जन करना",
		"create_company"=>"कंपनी बनाएं",
		"default"=>"चूक",
		"invalid_sorting_option"=>"अवैध सॉर्टिंग विकल्प",
		"items"=>"आइटम",
		"manage"=>"प्रबंधित",
		"name"=>"नाम",
		"not_hired"=>"किराए पर नहीं",
		"not_worked"=>"काम नहीं किया",
		"no_products_available_to_collect"=>"इकट्ठा करने के लिए कोई भी उत्पाद उपलब्ध नहीं है",
		"price"=>"मूल्य",
		"product"=>"उत्पाद",
		...
		"region"=>"क्षेत्र",
		"region_doesnt_exists"=>"क्षेत्र मौजूद नहीं है",
		"region_name"=>"क्षेत्र का नाम",
		"required"=>"अपेक्षित",
		"resources_fill"=>"संसाधन भरें",
		"sort_by"=>"क्रमबद्ध",
		"storage_fill"=>"संग्रहण भरें",
		"successfully_collected"=>"सफलतापूर्वक एकत्र किया गया",
		"this_country_has_not_researched_this_building"=>"इस देश ने इस इमारत का शोध नहीं किया है",
		"this_region_doesnt_have_required_resource_for_this_company"=>"इस क्षेत्र में इस कंपनी के लिए आवश्यक संसाधन नहीं हैं",
		...
		"you_are_not_allowed_to_build_companies_in_this_country"=>"आपको इस देश में कंपनियों का निर्माण करने की अनुमति नहीं है",
		"you_are_not_allowed_to_build_this_company_in_this_country"=>"आपको इस देश में उस कंपनी का निर्माण करने की अनुमति नहीं है",
		"you_dont_have_access_to_this_corporation"=>"आपके पास इस निगम की पहुंच नहीं है",
		"you_dont_have_enough_gold"=>"आपके पास पर्याप्त सोना नहीं है",
		"you_dont_have_enough_resources"=>"आपके पास पर्याप्त संसाधन नहीं हैं",
		"you_dont_own_any_company"=>"आपके पास कोई कंपनी नहीं है",
		"you_need_space_for_at_least"=>"कम से कम उस आइटम के लिए आपको स्थान की आवश्यकता है",
	);
?>
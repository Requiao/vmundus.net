<?php
	...
	$lang = array(
		...
		"change_location_for_people"=>"Standort für ändern",
		"chose_how_you_want_to_recover_persons_energy"=>"Wähle wie du die Energie der Person wiederherstellen möchtest.",
		"combat_experience"=>"Kampferfahrung",
		"details"=>"Details",
		"did_not_worked_today"=>"Hat heute nicht gearbeitet. Arbeitslosengeld gibt es hier nicht.",
		"energy"=>" Energie",
		"house_successfully_built"=>"Haus erfolgreich gebaut",
		"not_enough_energy_to_travel_the_person_should_have_at_least"=>"Nicht genug Energie um zu reisen. Die Person sollte mindestens haben",
		"recover"=>"regenerieren",
		"recover_energy_for_all_people"=>"Energie aller Menschen regenerieren",
		"regenerate"=>"auftanken",
		"retire"=>"austreten",
		"retire_from_army"=>"Von der Armee austreten",
		"select_all"=>"alle auswählen",
		"select_at_least_one_person"=>"mindestens eine Person wählen",
		"select_country"=>"Wähle das Land",
		"select_region_and_country_to_where_you_want_to_change_the_location_for_this_person_this_will_consume"=>"Wähle die Region und das Land, in das du den Standort für diese Person ändern möchtest. Dies wird verbrauchen",
		"successfully_retired_from_his_job"=>" zog sich erfolgreich von seinem Job zurück. Naja, do erfolgreich wurde er nicht.",
		"successfully_retired_from_the_army"=>" zog sich erfolgreich aus der Armee zurück. Angsthase!",
		"the_number_of_food_you_want_to_consume_must_be_a_number_and_between_1_and_10"=>"Die Anzahl der Lebensmittel, die du verzehren möchtest, muss eine Zahl zwischen 1 und 10 sein. Achte auf dein Gewicht",
		"the_person_successfully_renamed"=>"Die Person wurde erfolgreich umbenannt. Cooler Name",
		"this_person_already_has_full_energy"=>"Die Person hat bereits volle Energie, sie könnte jetzt einen Marathon laufen.",
		"today_you_cannot_recover_more_energy_for_this_person"=>"Für heute kannst du keine Energie mehr für diese Person wiederherstellen. Jeder braucht mal eine Pause",
		"total_people"=>"Menschen insgesamt",
		"train"=>"ausbilden",
		"train_new_soldiers"=>"Neue Soldaten ausbilden",
		"worked_today"=>"Heute gearbeitet",
		"work_experience"=>"Arbeitserfahrung",
		"youre_trying_to_move_this_person_to_his_current_location"=>"Hast du gerade ernsthaft versucht die Person an ihren jetzigen Ort zu bewegen?",
		"you_dont_have_enough_food_in_the_warehouse"=>"Du hast nicht genug Nahrung im Lagerhaus. Wie willst du deine Kinder versorgen?",
		"you_dont_have_this_product_in_your_warehouse"=>"Du hast dieses Produkt nicht im Lagerhaus.",
		"you_have_successfully_moved_to"=>"Endlich an deinen Traumort angelangt..",
		"you_have_successfully_recovered_energy_in_total_of"=>"Du hast erfolgreich Energie wiederhergestellt",

		//messages
		"choose_at_least_one_mail_to_delete"=>"Wähle mindestens eine Nachricht die du löschen möchtest.",
		"compose_message"=>"Nachricht verfassen",
		"delete"=>"löschen",
		"deleted"=>"gelöscht",
		"messages"=>"Nachrichten",
		"messages_successfully_deleted"=>"Nachrichten erfolgreich gelöscht",
		"notifications"=>"Benachrichtigungen",
		"other_member_deleted_this_conversation"=>"Dein Chat-Partner war sauer und hat diese Konversation gelöscht.",
		...
		"congress"=>"Parlament",
		"country_abbreviation"=>"Länderabkürzung",
		"country_currency"=>"Landeswährung",
		...
		"law_history"=>"Rechtsgeschichte",
		"member_of_the_union"=>"Member of the union",
		"nationality"=>"Staatsangehörigkeit",
		"new_people"=>"Neue Leute",
		...
		"persons_life_expectancy"=>"Lebenserwartung der Person",
		"politics"=>"Politics",
		...
		"taxes_on_import"=>"Einfuhrsteuern",

<?php
	...
	$lang = array(
		...
		//home
		"active_battles"=>"Batalhas Activas",
		"blogs"=>"Blogs",
		...
		"military"=>"Exercito",
		"parties"=>"Partidos",
		"party_info"=>"Informação do Partido",
		"players"=>"Jogadores",
		"politics"=>"Politica",
		...
		"store"=>"Loja",
		"unions"=>"Bloco Geopolítico",
		"unions_map"=>"Mapa de Blocos",
		"union_info"=>"Informação do Bloco Geopolitico",
		"warehouse"=>"Armazém",
		"work"=>"Trabalho",

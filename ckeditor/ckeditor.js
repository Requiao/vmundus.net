...
(function() {
        ...
        CKEDITOR.tools = {
            ...
            convertToPx: function() {
                ...
                return function(f) {
                    ...
                    return /%$/.test(f) ? f : (a.setStyle("width", f),
                    a.$.clientWidth)
                }
            }(),
            repeat: function(a, f) {
            ...
            parseCssText: function(a, f, b) {
                ...
                if (!a || ";" == a)
                    return c;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, b, k) {
                    f && (b = b.toLowerCase(),
            ...
            enableHtml5Elements: function(a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), k = c.length, d; k--; )
            ...
            keystrokeToString: function(a, b) {
                var c = b & 16711680
                  ...
                  , n = []
                  , e = [];
                c & CKEDITOR.CTRL && (n.push(d ? "⌘" : a[17]),
                e.push(d ? a[224] : a[17]));
                c & CKEDITOR.ALT && (n.push(d ? "⌥" : a[18]),
                e.push(a[18]));
                c & CKEDITOR.SHIFT && (n.push(d ? "⇧" : a[16]),
                e.push(a[16]));
                k && (a[k] ? (n.push(a[k]),
                e.push(a[k])) : (n.push(String.fromCharCode(k)),
                e.push(String.fromCharCode(k))));
                return {
                    display: n.join("+"),
                    aria: e.join("+")
                }
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            isEditable: function(a) {
                var b = this.getName();
                return this.isReadOnly() || "none" == this.getComputedStyle("display") || "hidden" == this.getComputedStyle("visibility") || CKEDITOR.dtd.$nonEditable[b] || CKEDITOR.dtd.$empty[b] || this.is("a") && (this.data("cke-saved-name") || this.hasAttribute("name")) && !this.getChildCount() ? !1 : !1 !== a ? (a = CKEDITOR.dtd[b] || CKEDITOR.dtd.span,
                !(!a || !a["#"])) : !0
            },
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
                    var e = this.$.getBoundingClientRect()
                      ...
                      , h = !0;
                    CKEDITOR.env.ie && (h = f.getDocumentElement().contains(this),
                    f = f.getBody().contains(this),
                    h = w && f || !w && h);
                    h && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft,
                    c = d.$.scrollTop || g.scrollTop) : (c = w ? d.$ : g,
                    b = c.scrollLeft,
                    c = c.scrollTop),
                    b = e.left + b - m,
                    c = e.top + c - x)
                    ...
                    for (x = this,
                    m = null; x && "body" != x.getName() && "html" != x.getName(); ) {
                        b += x.$.offsetLeft - x.$.scrollLeft;
                        c += x.$.offsetTop - x.$.scrollTop;
                        x.equals(this) || (b += x.$.clientLeft || 0,
                        c += x.$.clientTop || 0);
                        for (; m && !m.equals(x); )
                            b -= m.$.scrollLeft,
                            c -= m.$.scrollTop,
                ...
                a && (e = this.getWindow(),
                x = a.getWindow(),
                !e.equals(x) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a),
                b += a.x,
                c += a.y));
                document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || w || (b += this.$.clientLeft ? 1 : 0,
            ...
            scrollIntoParent: function(a, b, c) {
                var f, d, w, e;
                function g(b, c) {
                    /body|html/.test(a.getName()) ? a.getWindow().$.scrollBy(b, c) : (a.$.scrollLeft += b,
                    a.$.scrollTop += c)
                }
                function x(a, b) {
                    var c = {
                    ...
                    f = a.getWindow();
                    f.equals(b) || (f = x(CKEDITOR.dom.element.get(f.$.frameElement), b),
                    c.x += f.x,
                    c.y += f.y);
                    return c
                }
            ...
            getEditor: function(a) {
                ...
                for (c in b)
                    if (f = b[c],
                    f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (d = f.editable()) && (d.equals(this) || d.contains(this)))
                        return f;
                return null
            },
            find: function(a) {
    ...
    (function() {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, D = c.endOffset, g, l = this.guard, t = this.type, J = a ? "getPreviousSourceNode" : "getNextSourceNode";
            ...
            : v;
            this.current ? f = this.current[J](!1, t, g) : (a ? f.type == CKEDITOR.NODE_ELEMENT && (f = 0 < D ? f.getChild(D - 1) : !1 === g(f, !0) ? null : f.getPreviousSourceNode(!0, t, g)) : (f = d,
            f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, t, g)))),
            f && !1 === g(f) && (f = null));
            for (; f && !this._.end; ) {
                this.current = f;
        ...
        CKEDITOR.dom.walker.editable = function(a) {
            return function(b) {
                b = u(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        }
        ;
        CKEDITOR.dom.element.prototype.getBogus = function() {
            ...
            while (n(a));return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1
        }
    }
    )();
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function g(a, b, c, f) {
                ...
                if (f && h)
                    return d;
                l || f ? b.append(a.clone(!0, e), c) : (a.remove(),
                u && b.append(a, c));
                return d
            }
            function m() {
            ...
            function k() {
                var b = C - 1
                  , c = v && B && !t.equals(J);
                b < r - 1 || b < G - 1 || c ? (c ? a.moveToPosition(J, CKEDITOR.POSITION_BEFORE_START) : G == b + 1 && y ? a.moveToPosition(p[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(p[b + 1], CKEDITOR.POSITION_BEFORE_START),
                d && (b = O[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document),
                c.insertAfter(b),
                b.mergeSiblings(!1),
                a.moveToBookmark({
                    startNode: c
            ...
            var h = 0 === b
              ...
              , l = 2 == b;
            b = l || u;
            var t = a.startContainer, J = a.endContainer, H = a.startOffset, E = a.endOffset, q, y, v, B, L, n;
            if (l && J.type == CKEDITOR.NODE_TEXT && (t.equals(J) || t.type === CKEDITOR.NODE_ELEMENT && t.getFirst().equals(J)))
                c.append(a.document.createText(J.substring(H, E)));
            else {
                J.type == CKEDITOR.NODE_TEXT ? l ? n = !0 : J = J.split(E) : 0 < J.getChildCount() ? E >= J.getChildCount() ? (J = J.getChild(E - 1),
                y = !0) : J = J.getChild(E) : B = y = !0;
                t.type == CKEDITOR.NODE_TEXT ? l ? L = !0 : t.split(H) : 0 < t.getChildCount() ? 0 === H ? (t = t.getChild(H),
                q = !0) : t = t.getChild(H - 1) : v = q = !0;
                for (var O = t.getParents(), p = J.getParents(), C = m(), r = O.length - 1, G = p.length - 1, N = c, P, Y, V, ea = -1, Q = C; Q <= r; Q++) {
                    Y = O[Q];
                    V = Y.getNext();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E,
                    H = !!E),
                    E && ((t = E.getPrevious()) || (l = E.getParent()))) : (y && (t = E.getChild(y - 1) || E.getLast()),
                    t || (l = E));
                    for (l = c(l); l || t; ) {
                        if (l && !t) {
                            !J && l.equals(m) && (J = !0);
                            if (e ? l.isBlockBoundary() : !k.contains(l))
                                break;
                            H && "inline" == l.getComputedStyle("display") || (H = !1,
                            J ? h = l : this.setStartBefore(l));
                            t = l.getPrevious()
                        }
                        for (; t; )
                            if (E = !1,
                    ...
                    l = t = null;
                    J = H = !1;
                    E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(y)).length ? H = !0 : (H = !E.getLength(),
                    y == E.getLength() ? (t = E.getNext()) || (l = E.getParent()) : g(E, y) && (l = E.getParent())) : (t = E.getChild(y)) || (l = E);
                    for (; l || t; ) {
                        if (l && !t) {
                            !J && l.equals(m) && (J = !0);
                            if (e ? l.isBlockBoundary() : !k.contains(l))
            ...
            shrink: function(a, b, c) {
                ...
                if (!this.collapsed) {
                    ...
                    var g = this.clone()
                      ...
                      , u = this.endOffset
                      , l = c = 1;
                    m && m.type == CKEDITOR.NODE_TEXT && (h ? h >= m.getLength() ? g.setStartAfter(m) : (g.setStartBefore(m),
                    c = 0) : g.setStartBefore(m));
                    k && k.type == CKEDITOR.NODE_TEXT && (u ? u >= k.getLength() ? g.setEndAfter(k) : (g.setEndAfter(k),
                    l = 0) : g.setEndBefore(k));
                    ...
                    g.guard = function(b, c) {
                        if (e && J(b) || t(b))
                            return !0;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(H) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))
                            return !1;
            ...
            splitBlock: function(a, b) {
                ...
                this.deleteContents();
                e && e.equals(g) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END),
                g = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START),
                e = null) : (g = this.splitElement(e, b || !1),
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                var b = CKEDITOR.dom.walker.whitespaces()
                  , c = CKEDITOR.dom.walker.bookmark(!1);
                return function(b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, g; e && !e.equals(d.root) && !e.getFirst(a(e)); )
                        g = e.getParent(),
            ...
            moveToClosestEditablePosition: function(a, b) {
                ...
                if (a && !a.is(CKEDITOR.dtd.$block))
                    ...
                    d = 1,
                    (g = e.type == CKEDITOR.NODE_ELEMENT) && e.is(CKEDITOR.dtd.$block) && "false" == e.getAttribute("contenteditable") ? (c.setStartAt(e, CKEDITOR.POSITION_BEFORE_START),
                    c.setEndAt(e, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && g && e.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(e, 0),
                    c.collapse()) : c.moveToPosition(e, m[b ? 1 : 0]);
            ...
            _find: function(a, b) {
                ...
                if (c && c.find)
                    ...
                    g = 0; g < m.count(); g++)
                        if (c = m.getItem(g),
                        b || !c.isReadOnly())
                            k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c),
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    x.collapsed || (h = new CKEDITOR.dom.walker(x.clone()),
                    ...
                    this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (m = this.range.clone(),
                    m.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END),
                    m.checkEndOfBlock() && (m = new CKEDITOR.dom.elementPath(m.endContainer,m.root),
                    this._.lastNode = (m.block || m.blockLimit).getNextSourceNode(!0))),
                    this._.lastNode && x.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = x.document.createText(""),
                ...
                for (this._.nextNode = null; m; ) {
                    var K = 0
                      ...
                      , l = 0;
                    if (I)
                        m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
                    else {
                        var t = m.getName();
                        if (CKEDITOR.dtd.$block[t] && "false" == m.getAttribute("contenteditable")) {
                            ...
                            h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START),
                            "br" != t && (this._.nextNode = m));
                            K = 1
                        } else {
                            if (m.getFirst()) {
                                h || (h = this.range.clone(),
                    ...
                    I && !h && (h = this.range.clone(),
                    h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                    w = (!K || I) && m.equals(x);
                    if (h && !K)
                        for (; !m.getNext(k) && !w; ) {
                            t = m.getParent();
                            if (t.isBlockBoundary(this.forceBrBreak && !z && {
                                br: 1
                            })) {
                                K = 1;
                                I = 0;
                ...
                if (!d) {
                    ...
                    d = d.block;
                    !d && m && !this.enforceRealBlocks && K[m.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !m.equals(h.root) ? d = m : !d || this.enforceRealBlocks && d.is(n) ? (d = this.range.document.createElement(a),
                    h.extractContents().appendTo(d),
                    d.trim(),
                    h.insertNode(d),
                    A = F = !0) : "li" != d.getName() ? h.checkStartOfBlock() && h.checkEndOfBlock() || (d = d.clone(!1),
                    h.extractContents().appendTo(d),
                    d.trim(),
                    F = h.splitBlock(),
                    A = !F.wasStartOfBlock,
                    F = !F.wasEndOfBlock,
                    h.insertNode(d)) : w || (this._.nextNode = d.equals(x) ? null : this._getNextSourceNode(h.getBoundaryNodes().endNode, 1, x))
                }
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (g in O) {
                    ...
                    G = void 0;
                    for (G in t)
                        -1 < G.indexOf("*") ? m.push(new RegExp("^" + G.replace(/\*/g, ".*") + "$")) : m.push(G);
                    t = m;
                    t.length && (r[q] = t,
                    p = !1)
                }
                ...
                if (!0 === l.elements || null === l.elements)
                    ...
                    for (k in r = l.elements,
                    delete l.elements,
                    r)
                        if (b[k])
                            b[k][f ? "unshift" : "push"](l);
                        else
                            b[k] = [l]
            }
        }
        ...
        function k(a, b) {
            ...
            if (e = a.requiredClasses)
                ...
                c = 0; c < e.length; ++c)
                    if (d = e[c],
                    "string" == typeof d) {
                        if (-1 == CKEDITOR.tools.indexOf(l, d))
                            return !1
        ...
        function A(a, b, e, l) {
            ...
            if (l.doFilter) {
                ...
                if (!a.allAttributes)
                    for (H in v)
                        C[H] || (O.test(H) ? H == (N = H.replace(/^data-cke-saved-/, "")) || C[N] || (delete v[H],
                        B = !0) : (delete v[H],
                        B = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (H in k)
                        a.allStyles || h[H] ? E.push(H + ":" + k[H]) : B = !0;
                ...
                if ("br" == b)
                    ...
                    b: {
                        ...
                        for (var l = 0, r = d.length, f; l < r; ++l)
                            if (f = d[l],
                            f.type == CKEDITOR.NODE_ELEMENT && !e[f.name]) {
                                e = !1;
                                break b
                            }
                        e = !0
                    ...
                    if (e)
                        ...
                        e = a.parent;
                        for (var l = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, q, r = d.length; 0 < r; )
                            f = d[--r],
                            l && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && y.$inline[f.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b),
                            v.insertAfter(a),
                            c.push({
                                check: "parent-down",
                                el: v
                            ...
                            q = y[e.name] || y.span,
                            f.insertAfter(a),
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.type != CKEDITOR.NODE_ELEMENT || q[f.name] || c.push({
                                check: "el-up",
                                el: f
                            }));
                        a.remove()
        ...
        function J(a, b) {
            ...
            for (l in d)
                if ("class" == l)
                    for (c = d[l].split(/\s+/),
                    r = a.classes.join("|"); v = c.pop(); ) {
                        if (-1 == r.indexOf(v))
                            return !1
                    }
                else if (a.attributes[l] != d[l])
                    return !1;
            for (f in e)
                if (a.styles[f] != e[f])
                    return !1;
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                this.allow(L[a.enterMode] + " " + L[a.shiftEnterMode], "default", 1),
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                if (this.disabled)
                    return !1;
                var e = this, f = [], r = this.editor && this.editor.config.protectedSource, v, q = !1, g = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                for (; p = a.pop(); )
                    if (c = p.el,
                    c.parent)
                        switch (t = y[c.parent.name] || y.span,
                        p.check) {
                        case "it":
                            y.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : m(c) || l(c, d, a);
                            break;
                        case "el-up":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || t[c.name] || l(c, d, a);
                            break;
                        case "parent-down":
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        ...
                        for (f = 0; f < b.length; ++f)
                            ...
                            p = r.right),
                            l || (l = r,
                            l = l.element ? l.element : v ? v.match(/^([a-z0-9]+)/i)[0] : l.left.getDefinition().element),
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    e = d.styles,
                    r = d.attributes || {},
                    e && !CKEDITOR.tools.isEmpty(e) ? (e = v(e),
                    r.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {},
                    e = {
                        name: d.element,
                        attributes: r,
        ...
        }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, C = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
        }, r = /^cke:(object|embed|param)$/, G = /^(object|embed|param)$/, N;
                        ...
                        if (!d[f]) {
                            if (k.icons)
                                for (var A = k.icons.split(","), F = A.length; F--; )
                                    CKEDITOR.skin.addIcon(A[F], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[F] + ".png");
                            d[f] = 1
                        }
                        if (w)
                            for (w.split && (w = w.split(",")),
                            k = 0; k < w.length; k++)
                                g[w[k]] || b.push(w[k])
                    }
                    if (b.length)
    ...
    (function() {
        ...
        function h(a) {
            ...
            CKEDITOR.getUrl(a.config.customConfig) != b && h(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function() {
        ...
        function D(a) {
            var b = a.config
              ...
              , e = b.removePlugins;
            if (d)
                var f = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)","g")
                  , c = c.replace(f, "")
                  , c = c + ("," + d);
            if (e)
                var g = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)","g")
                  , c = c.replace(g, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var l in c) {
                    ...
                    k && !a.lang[l] && (k.split && (k = k.split(",")),
                    0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""),
                    h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, h) ? h : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]),
                    t.langEntries && t.langEntries[h] ? (a.lang[l] = t.langEntries[h],
                    h = null) : f.push(CKEDITOR.getUrl(t.path + "lang/" + h + ".js")));
                    e.push(h);
                    d.push(t)
                }
        ...
        function A(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                ...
                c(q) ? (f || (f = y.getAscendant("table").clone(),
                f.append(y.getAscendant({
                    thead: 1,
                    tbody: 1,
                    tfoot: 1
                }).clone()),
                ...
                k = y.clone(),
                f.append(k)),
                k.append(d(q))) : e.append(q.cloneContents())
            }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            execCommand: function(a, b) {
                ...
                return c && c.state != CKEDITOR.TRISTATE_DISABLED && !1 !== this.fire("beforeCommandExec", d) && (d.returnValue = c.exec(d.commandData),
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b); ) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(),
                        h && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(h.join("")),
                        h = null),
                        !h) {
                            this.onTagClose(e);
                            continue
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(g, h, k) {
            function n(a) {
                ...
                if (0 < m.length)
                    for (var c = 0; c < m.length; c++) {
                        ...
                        l && !l[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == z.name && (D(z, z.parent, 1),
                        c--) : (b || (u(),
                        b = 1),
                        d = d.clone(),
                        d.parent = z,
            ...
            function D(b, c, d) {
                ...
                "pre" == b.name && (l = !1),
                "textarea" == b.name && (I = !1));
                b.returnPoint ? (z = b.returnPoint,
                delete b.returnPoint) : z = d ? c : e
            }
            function w(a, b) {
            ...
            F.onTagOpen = function(e, f, g, k) {
                ...
                if (a(f))
                    ...
                    if ("br" == e)
                        ...
                        for (; !(k = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c,
                        f.isUnknown || z.isUnknown || k[e]); )
                            if (z.isOptionalClose)
                                ...
                                !f.returnPoint && (f.returnPoint = z),
                                z = z.parent;
                            else if (g in CKEDITOR.dtd.$inline && m.unshift(z),
                            z.parent)
                                D(z, z.parent, 1);
                            else {
                                f.isOrphan = 1;
            ...
            ;
            F.onText = function(a) {
                if (!(z._.hasInlineStarted && !K.length || l || I) && (a = CKEDITOR.tools.ltrim(a),
                0 === a.length))
                    return;
                var b = z.name
    ...
    (function() {
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), h = this.rules, k = h.length, n, u, f, D;
                for (D = 0; D < k; D++)
                    if (d && (n = c.type,
                    u = c.name),
                    f = h[D],
                    !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
                        f = f.value.apply(null, g);
                        if (!1 === f || d && f && (f.name != u || f.type != n))
                            return f;
                        null != f && (g[0] = c = f)
                    }
                return c
    ...
    (function() {
        function a(a, d) {
                    ...
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (r)
                            for (q(r, 1) && l.push(r); r; )
                                g(r) && (v = c(r)) && q(v) && ((p = c(v)) && !g(p) ? l.push(v) : (f(y).insertAfter(v),
                                v.remove())),
                                r = r.previous;
                        for (r = 0; r < l.length; r++)
                            l[r].remove();
                        if (l = !a || !1 !== ("function" == typeof d ? d(e) : d))
                            y || CKEDITOR.env.needsBrFiller || e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (l = b(e),
                            l = !l || "form" == e.name && "input" == l.name) : l = !1 : l = !1;
                        l && e.add(f(a))
                    }
                }
            }
            function q(a, b) {
                ...
                a.value = c[0]),
                !CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in B) || !y && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }
            var p = {
                elements: {}
            }, y = "html" == d, B = CKEDITOR.tools.extend({}, l), C;
            for (C in B)
                "#"in z[C] || delete B[C];
            for (C in B)
                p.elements[C] = v(y, a.config.fillEmptyBlocks);
            p.root = v(y, !1);
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) {
                a = a.data;
                var c = a.dataValue, e, c = x(c, b), c = f(c, L), c = u(c), c = f(c, B), c = c.replace(O, "$1cke:$2"), c = c.replace(C, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"), c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2");
                e = a.context || b.editable().getName();
                var l;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == e && (e = "div",
                ...
                e && (l = c,
                !l.children.length && CKEDITOR.dtd[l.name][e] && (e = new CKEDITOR.htmlParser.element(e),
                l.add(e)));
                a.dataValue = c
            }, null, null, 5);
            b.on("toHtml", function(a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                ...
                b && "object" == typeof b ? (f = b.context,
                c = b.fixForBody,
                d = b.dontFilter,
                l = b.filter,
                v = b.enterMode,
                g = b.protectedWhitespaces) : f = b;
            ...
            elements: {
                ...
                table: function(a) {
                    a.children.slice(0).sort(function(a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(I, a.name),
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (n in h) {
                    ...
                    u && (!1 === (k = a.onAttribute(b, d, u, k)) ? delete h[u] : h[u] = k)
                }
    ...
    (function() {
        function a(a, e, g, h) {
            ...
            h == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"),
        ...
        function b(a) {
            ...
            h == CKEDITOR.ELEMENT_MODE_REPLACE ? (d.hide(),
    ...
    (function() {
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (g = d(g, e))
                    g.appendBogus(),
                    y = CKEDITOR.env.ie;
            h(b, e.block, f) && q.collapsed && !q.getCommonAncestor().isReadOnly() && (e = q.clone(),
            ...
            ,
            !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = q.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"),
        ...
        function b(a) {
            ...
            b.is("input") && (b = b.getAttribute("type"),
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    f && ((f = a.getNext(function(a) {
                        return c(a) && !A(a)
                    })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"),
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, v;
                    if (f)
                        for (; (g = b.getCommonAncestor(0, 1)) && (v = CKEDITOR.dtd[g.getName()]) && (!v || !v[e]); )
                ...
                fixInitialSelection: function() {
                    ...
                    function b() {
                        ...
                        "None" == d.type && e.equals(c) && (d = new CKEDITOR.dom.range(c),
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) {
                        ...
                        d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START),
                        c.block.remove())
                    } else
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            ...
                            q ? h != q.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? q.$.styleSheet.cssText = h : q.setText(h)) : (h = e.appendStyleText(h),
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in y) {
                                    ...
                                    CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (e = b.getSelectedElement()) || (e = g(b)) ? (a.fire("saveSnapshot"),
                                    q.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START),
                                    e.remove(),
                                    q.select(),
                                    a.fire("saveSnapshot"),
                                    d = 1) : q.collapsed && ((C = p.block) && (k = C[c ? "getPrevious" : "getNext"](f)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("table") && q[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"),
                                    q[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && C.remove(),
                                    q["moveToElementEdit" + (c ? "End" : "Start")](k),
                                    q.select(),
                                    a.fire("saveSnapshot"),
                                    d = 1) : p.blockLimit && p.blockLimit.is("td") && (r = p.blockLimit.getAscendant("table")) && q.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (k = r[c ? "getPrevious" : "getNext"](f)) ? (a.fire("saveSnapshot"),
                                    q["moveToElementEdit" + (c ? "End" : "Start")](k),
                                    q.checkStartOfBlock() && q.checkEndOfBlock() ? k.remove() : q.select(),
                                    a.fire("saveSnapshot"),
                                    d = 1) : (r = p.contains(["td", "th", "caption"])) && q.checkBoundaryOfElement(r, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                                }
                                return !d
                            }
                        });
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) {
                            b.data.getKeystroke()in y && !this.getFirst(c) && (this.appendBogus(),
                            b = a.createRange(),
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (c in y && (b = a.getSelection(),
                            0 !== b.getRanges().length)) {
                                var c = 8 == c
                                  , d = b.getRanges()[0];
                                b = d.startPath();
                                if (d.collapsed)
                                    ...
                                    p = b.block,
                                    d = c.endPath().block,
                                    p && d && !p.equals(d) ? (a.fire("saveSnapshot"),
                                    (e = p.getBogus()) && e.remove(),
                                    c.enlarge(CKEDITOR.ENLARGE_INLINE),
                                    c.deleteContents(),
                                    d.getParent() && (d.moveChildren(p, !1),
                                    b.lastElement.mergeSiblings(),
                                    u(p, d, !0)),
        ...
        x = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var k = v[k.getName()], h = 0, B = c.getChildren(), n = B.count(), L = -1, u = -1, E = 0, H = e.contains(v.$list); h < n; ++h)
                    e = B.getItem(h),
                    a(e) ? (q = e.getName(),
                    H && q in CKEDITOR.dtd.$list ? y = y.concat(b(e, d)) : (g = !!k[q],
                    "br" != q || !e.data("cke-eol") || h && h != n - 1 || (E = (f = h ? y[h - 1].node : B.getItem(h + 1)) && (!a(f) || !f.is("br")),
            ...
            function q(b, c, d, e) {
                ...
                (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && B[g.getName()] && (v = g.getPrevious()) && a(v) && !v.getParent().equals(b.startContainer) && d.contains(v) && e.contains(g) && g.isIdentical(v) && (g.moveChildren(v),
                g.remove(),
                q(b, c, d, e))
            }
            function g(b, c) {
                ...
                e && d(e, b[b.length - 1]);
                f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1),
                c.collapse())
            }
            var v = CKEDITOR.dtd
              , B = {
            ...
            return function(B, p, C, r) {
                ...
                if (!r.checkReadOnly()) {
                    ...
                    r = B.mergeCandidates;
                    var m, w;
                    "text" == B.type && p.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (m = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", p.document),
                    p.insertNode(m),
                    p.setStartAfter(m));
                    ...
                    for (G = m.startNode; (G = G.getParent()) && f(G); )
                        r.push(G);
                    p.moveToBookmark(m);
                    if (m = C) {
                        m = B.range;
                        ...
                        D && (w.getFirst().remove(),
                        w.getLast().remove());
                        if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus()))
                            a: {
                                var A;
                                if (1 == w.getChildCount() && a(A = w.getFirst()) && A.is(n) && !A.hasAttribute("contenteditable")) {
                    ...
                    if (m) {
                        ...
                        var I, K;
                        p = A.startContainer;
                        var N = B.endPath.elements[0], X, P = N.getPosition(p), x = !!N.getCommonAncestor(p) && P != CKEDITOR.POSITION_IDENTICAL && !(P & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        p = b(B.dataWrapper, B);
                        for (g(p, A); r < p.length; r++) {
                            ...
                            if (M = P.isLineBreak) {
                                ...
                                Z == CKEDITOR.POSITION_IDENTICAL || Z == CKEDITOR.POSITION_CONTAINS ? M = 0 : (I = M.splitElement(S),
                            ...
                            if (M)
                                ...
                                M = A.startPath();
                                !P.isBlock && h(B.editor, M.block, M.blockLimit) && (T = k(B.editor)) && (T = m.createElement(T),
                                T.appendBogus(),
                                A.insertNode(T),
                                CKEDITOR.env.needsBrFiller && (z = T.getBogus()) && z.remove(),
                                ...
                                if (G && P.isElement) {
                                    ...
                                    if (M)
                                        ...
                                        M = r == p.length - 1;
                                        I = d(P.node, I);
                                        for (var S = [], Z = I.length, aa = 0, ca = void 0, da = 0, U = -1; aa < Z; aa++)
                                            ca = I[aa],
                                            " " == ca ? (da || X && !aa || (S.push(new CKEDITOR.dom.text(" ")),
                                            U = S.length),
                                            da = 1) : (S.push(ca),
                                            da = 0);
                                        M && U == S.length && S.pop();
                                ...
                                if (X) {
                                    ...
                                    A.insertNode(P.node);
                                P.lastNotAllowed && r < p.length - 1 && ((K = x ? N : K) && A.setEndAt(K, CKEDITOR.POSITION_AFTER_START),
                                G = 0);
                                A.collapse()
                            }
                        }
                        1 != p.length ? z = !1 : (z = p[0],
                        z = z.isElement && "false" == z.node.getAttribute("contenteditable"));
                        z && (C = !0,
                        M = p[0].node,
                    ...
                    for (X = z.createBookmark(); F = B.zombies.pop(); )
                        F.getParent() && (T = z.clone(),
                        T.moveToElementEditStart(F),
                        T.removeEmptyBlocksAtEnd());
                    if (K)
                        for (; F = K.pop(); )
                            CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(z.document.createText(" "));
                    for (; F = B.mergeCandidates.pop(); )
                        F.mergeSiblings();
                    z.moveToBookmark(X);
                    if (!B.dontMoveCaret) {
        ...
        K = function() {
            ...
            return function(b) {
                ...
                b.collapse(!0),
                e.remove()) : ((c = e.getBogus()) && c.remove(),
        ...
        I = function() {
            ...
            return {
                ...
                table: function() {
                    function a(c) {
                        var e = [], f, g = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d), h = c.endPath().contains(d), p = {};
                        g.guard = function(a, g) {
                            ...
                            if (g && k && a.equals(k))
                                ...
                                if (l = !g)
                                    l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
                                l && (f = c.clone(),
                    ...
                    return {
                        ...
                        detectRanges: function(e, f) {
                            ...
                            l = l.contains("table");
                            if (p || l)
                                p && l && b(p, l) ? (e.tableSurroundingRange = k,
                                ...
                                h = a(k).concat(a(h))) : p ? l || (e.tableSurroundingRange = k,
                                k.setStartAt(p, CKEDITOR.POSITION_AFTER_END),
                                g.setEndAt(p, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = k,
                                k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(), d;
                    h(a, c.block, c.blockLimit) && (d = k(a)) && (d = b.document.createElement(d),
                    d.appendBogus(),
                    b.insertNode(d),
    ...
    (function() {
        function a(a, b) {
            ...
            if ((c = !b && 1 === a.length) && !(c = a[0].collapsed)) {
                ...
                c && c.equals(f) && !c.findOne("td, th, tr, tbody, table") ? (e = e.cloneContents(),
                c = e.getFirst() ? d(e.getFirst().getText()) !== d(c.getText()) : !0) : c = !1
            }
            if (c)
                return !1;
            for (d = 0; d < a.length; d++)
                if (c = a[d]._getTableElement(),
                !c)
                    return !1;
            return !0
        }
        ...
        function b(a) {
            ...
            for (f = 0; f < a.length; f++)
                e && !e.equals(a[f].getAscendant("tr")) ? (b += c.join("\t") + "\n",
                e = a[f].getAscendant("tr"),
                c = []) : 0 === f && (e = a[f].getAscendant("tr")),
                c.push(a[f].getText());
            return b += c.join("\t")
        }
        function c(a) {
        ...
        function e() {
            ...
            CKEDITOR.env.webkit && !d && (this._.previousActive = this.document.getActive()),
        ...
        function g() {
            t = !0;
            l || (h.call(this),
            l = CKEDITOR.tools.setTimeout(h, 200, this))
        }
        function h() {
            l = null;
            t && (CKEDITOR.tools.setTimeout(e, 0, this),
            t = !1)
        }
        function k(a) {
                ...
                if (!c.collapsed) {
                    ...
                    d.evaluator = function(d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                            ...
                            d.getPosition(p.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d),
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                var k = c.document, p = CKEDITOR.document, h = c.editable(), r = k.getBody(), l = k.getDocumentElement(), q = h.isInline(), y, n;
                CKEDITOR.env.gecko && h.attachListener(h, "focus", function(a) {
                    a.removeListener();
                    0 !== y && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = c.createRange(),
                ...
                if (CKEDITOR.env.ie || q)
                    x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1),
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    h.attachListener(h, "mousedown", function(a) {
                        2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (m = c.window.getScrollPosition()))
                    });
                    h.attachListener(h, "mouseup", function(a) {
                        2 == a.data.$.button && m && (c.document.$.documentElement.scrollLeft = m.x,
                    ...
                    if ("BackCompat" != k.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)
                            l.on("mousedown", function(a) {
                                a.data.getTarget().is("html") && (p.on("mouseup", b),
                                l.on("mouseup", b))
                            })
                    }
                }
                ...
                if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    h.attachListener(CKEDITOR.env.ie ? h : k.getDocumentElement(), "mouseup", g, c);
        ...
        if (CKEDITOR.env.webkit)
            CKEDITOR.on("instanceReady", function(a) {
                ...
                b.on("selectionChange", function() {
                    ...
                    c && (c.getCustomData("ready") ? (f(a),
                    a.editor.fire("selectionCheck")) : c.setCustomData("ready", 1))
                }, null, null, -1);
        ...
        CKEDITOR.editor.prototype.lockSelection = function(a) {
            ...
            return a.getType() != CKEDITOR.SELECTION_NONE ? (!a.isLocked && a.lock(),
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (b)
                return CKEDITOR.tools.extend(this._.cache, b._.cache),
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = x ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, q = -1, n, m; k <= l; )
                            if (q = Math.floor((k + l) / 2),
                            f = e[q],
                        ...
                        if (-1 == q || q == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < h && 0 < d; )
                                g = e[--d],
                                g.nodeType == CKEDITOR.NODE_TEXT && (m = g,
                        ...
                        for (; 0 < h; )
                            try {
                                ...
                                g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length,
                                m = g),
                                f = g
                            } catch (u) {
                                return {
            ...
            selectRanges: function(b) {
                ...
                if (b.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var p, C;
                            if (1 == b.length && !(C = b[0]).collapsed && (l = C.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (C = C.clone(),
                            C.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                            (p = C.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (l = p),
                        ...
                        if (l)
                            this.fake(l);
                        else if (d && d.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && a(b) && !I)
                            c.call(this, b);
                        else {
                            if (x) {
                                ...
                                1 < b.length && (d = b[b.length - 1],
                                b[0].setEnd(d.endContainer, d.endOffset));
                                d = b[0];
                                b = d.collapsed;
                                var r, G, m;
                                if ((e = d.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName()in E && (!e.is("a") || !e.getText()))
                                    try {
                                ...
                                if (d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName()in C || d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName()in C)
                                    d.shrink(CKEDITOR.NODE_ELEMENT, !0),
                                    b = d.collapsed;
                                m = d.createBookmark();
                                C = m.startNode;
                                b || (k = m.endNode);
                                ...
                                k ? (l = d.document.$.body.createTextRange(),
                                l.moveToElementText(k.$),
                                m.setEndPoint("EndToEnd", l),
                                m.moveEnd("character", -1)) : (r = C.getNext(p),
                                G = C.hasAscendant("pre"),
                                r = !(r && r.getText && r.getText().match(l)) && (G || !C.hasPrevious() || C.getPrevious().is && C.getPrevious().is("br")),
                                ...
                                d.setStartBefore(C);
                                C.remove();
                                b ? (r ? (m.moveStart("character", -1),
                                m.select(),
                                d.document.$.selection.clear()) : m.select(),
                                d.moveToPosition(G, CKEDITOR.POSITION_BEFORE_START),
                                G.remove()) : (d.setEndBefore(k),
                                k.remove(),
                                m.select())
                            } else {
                                k = this.getNative();
                                ...
                                for (m = 0; m < b.length; m++) {
                                    ...
                                    d.collapsed && CKEDITOR.env.webkit && n(d) && (l = u(this.root),
                                    d.insertNode(l),
                                    (r = l.getNext()) && !l.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (f(this.root),
                                    d.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : d.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
            ...
            selectBookmarks: function(b) {
                ...
                b.isFake && (d = a(c) ? c[0]._getTableElement() : c[0].getEnclosedNode(),
                d && d.type == CKEDITOR.NODE_ELEMENT || (CKEDITOR.warn("selection-not-fake"),
                b.isFake = 0));
    ...
    (function() {
                ...
                for (q.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q; ) {
                    ...
                    if (q.equals(t))
                        ...
                        if (y)
                            ...
                            H = g,
                            I = k,
                            !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E))
                                l = !0;
                            else {
                                if (v || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(t) | W) != W || (v = c.clone(),
                                v.setStartBefore(q)),
                                A = q.type,
                                A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                    for (var A = q, L; (l = !A.getNext(B)) && (L = A.getParent(),
                                    n[L.getName()]) && d(L, w, h, O); )
                                        A = L;
                                    v.setEndAfter(A)
                                }
                            }
                    ...
                    if (l && v && !v.collapsed) {
                        for (var l = K(this, f), x = l.hasAttributes(), D = v.getCommonAncestor(), A = {}, y = {}, E = {}, H = {}, U, R, ba; l && D; ) {
                            if (D.getName() == g) {
                                for (U in h.attributes)
                                    !H[U] && (ba = D.getAttribute(R)) && (l.getAttribute(U) == ba ? y[U] = 1 : H[U] = 1);
                                for (R in h.styles)
                                    !E[R] && (ba = D.getStyle(R)) && (l.getStyle(R) == ba ? A[R] = 1 : E[R] = 1)
                            }
                            D = D.getParent()
                        }
                        for (U in y)
                        ...
                        l ? (v.extractContents().appendTo(l),
                        v.insertNode(l),
                        F.call(this, l),
                        l.mergeSiblings(),
                        CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"),
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(),a.root), g, h = 0, k; h < f.elements.length && (k = f.elements[h]) && k != f.block && k != f.blockLimit; h++)
                    if (this.checkElementRemovable(k)) {
                        var m;
                        !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (m = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (g = k,
                        g.match = m ? "start" : "end") : (k.mergeSiblings(),
                ...
                for (f = d; !f.equals(n); )
                    ...
                    f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]),
                    g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(),
                    g = d.getNext())),
                    f = g
            }
            a.moveToBookmark(c);
        ...
        function k(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph(); )
                !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = K(this, e, d),
                u(d, f));
            a.moveToBookmark(b)
        }
        function n(a) {
            ...
            for (var d, e; d = c.getNextParagraph(); )
                this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e),
                u(d, e)) : A.call(this, d));
            a.moveToBookmark(b)
        }
        function u(a, b) {
            ...
            if (d && !e) {
                ...
                g ? b = w(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
        ...
        function A(a, b) {
            ...
            for (g in d)
                if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == t(g, d[g]))
                    b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g),
                    a.removeAttribute(g));
            for (var h in c)
                this._.definition.fullMatch && a.getStyle(h) != t(h, c[h], !0) || (f = f || !!a.getStyle(h),
                a.removeStyle(h));
            x(a, e, E[a.getName()]);
            ...
            do
                if (n.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (n.equals(e))
                        break;
                    if (!h && (u = n.getName(),
                    "true" == n.getAttribute("contenteditable") ? h = n : !g && d[u] && (g = n),
                    a[u])) {
                        if (u = !g && "div" == u) {
                            a: {
                                u = n.getChildren();
    ...
    (function() {
        function a(a, c, d) {
            ...
            h.equals(n.getPrevious()) ? (c.startOffset = c.startOffset - h.getLength() - a.getPrevious().getLength(),
            h = a.getNext()) : h.equals(a.getPrevious()) && (c.startOffset -= h.getLength(),
            h = a.getNext());
...
*/
    ...
    (function() {
        ...
        function Z(a) {
            ...
            if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(), g, h, p, m, k, q, n = CKEDITOR.tools.addFunction(function(d) {
                    ...
                    e.$.getElementsByTagName("iframe").length && (q = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%;"\x3e\x3c/div\x3e'),
                    e.append(q));
                    ...
                    CKEDITOR.document.on("mousemove", b);
                    CKEDITOR.document.on("mouseup", c);
                    CKEDITOR.env.ie6Compat && (e = u.getChild(0).getFrameDocument(),
                    e.on("mousemove", b),
                    e.on("mouseup", c));
            ...
            function e(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    do {
                        ...
                        if (e == c)
                            break
                    } while (a && !b[e].isFocusable());b[e].focus();
        ...
        CKEDITOR.dialog.prototype = {
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    }, b), d = this._.contents[a.id] = {}, f = e.getChild(), g = 0; e = f.shift(); )
            ...
            selectPage: function(a) {
                if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
                    ...
                    CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (K(d[1]),
                    d[1].show(),
                    setTimeout(function() {
                        K(d[1], 1)
                    }, 0)) : d[1].show();
        ...
        var J, z = {}, u, w = {}, Q = function(a) {
            ...
            (b = w[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1],
        ...
        (function() {
            CKEDITOR.ui.dialog = {
                ...
                hbox: function(a, b, c, e, d) {
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, g = d && d.widths || null, h = d && d.height || null, p, m = {
                            role: "presentation"
                        };
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                function c() {
                    var f = a.mode;
                    f && (f = this.modes[f] ? void 0 !== m[f] ? m[f] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                ...
                if (this.modes) {
                    ...
                    d && (d = a.getCommand(d)) && (d.on("state", function() {
                ...
                this.icon && !/\./.test(this.icon) && (l = this.icon,
                this.icon = null);
                g = {
                    id: p,
                    name: k,
            ...
            init: function(a) {
                var d, f = function(c, h) {
                    ...
                    case q:
                        ...
                        while (b && !b.focus);b ? b.focus() : f(c, 9);
                        return !1;
                    case 40:
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, f) {
            ...
            if (f) {
                if (f = CKEDITOR.tools.search(c, function(a) {
                    ...
                    !f.groups && (f.groups = []);
                    if (d && (d = CKEDITOR.tools.indexOf(f.groups, d),
                    0 <= d)) {
    ...
    (function() {
        function q(b, d, a) {
            ...
            if ("wysiwyg" == b.mode) {
                ...
                var h = b.elementPath();
                h && !h.isContextFor("p") && (d = CKEDITOR.ENTER_BR,
                a = 1);
                b.fire("saveSnapshot");
        ...
        CKEDITOR.plugins.enterkey = {
                            ...
                            if (f = k.elementPath)
                                ...
                                n = f.elements.length; h < n; h++) {
                                    ...
                                    if (g.equals(f.block) || g.equals(f.blockLimit))
                                        break;
                                    CKEDITOR.dtd.$removeEmpty[g.getName()] && (g = g.clone(),
                                    e.moveChildren(g),
                                    e.append(g))
                                }
                            e.appendBogus();
            ...
            enterBr: function(b, d, a, h) {
                if (a = a || v(b)) {
                    ...
                    f.insertAfter(l),
                    a.setStart(f, 0)) : (f.createElement("br").insertAfter(l),
                    ...
                    b.getNext().$.nodeValue = "",
                    a.setStartAt(b.getNext(), CKEDITOR.POSITION_AFTER_START)) : a.setStartAt(b, CKEDITOR.POSITION_AFTER_END)),
                    a.collapse(!0),
                    a.select(),
        ...
        function k(a) {
            var l = a.config
              ...
              , t = function() {
                ...
                var m, k, n, c, h, q, v, p = l.floatSpaceDockedOffsetX || 0, r = l.floatSpaceDockedOffsetY || 0, u = l.floatSpacePinnedOffsetX || 0, x = l.floatSpacePinnedOffsetY || 0;
                return function(d) {
                    if (k = a.editable()) {
                        ...
                        d = h.width / 2,
                        d = l.floatSpacePreferRight ? "right" : 0 < c.left && c.right < h.width && c.width > n.width ? "rtl" == l.contentsLangDirection ? "right" : "left" : d - c.left > c.right - d ? "left" : "right",
        ...
        function m(a) {
            function f(a) {
                ...
                g.attachListener(g, "keyup", function() {
                    ...
                    b && (1 != d.count() || d.getItem(0).getCustomData("retain") || d.getItem(0).hasAttribute("data-cke-temp") || d.getItem(0).remove(1),
                    b = !1)
                })
            }
            var b = this.editor
            ...
            proto: {
                setData: function(a, f) {
                    ...
                    if (f)
                        ...
                        a = e + a) : a = c.docType + '\x3chtml dir\x3d"' + c.contentsLangDirection + '" lang\x3d"' + (c.contentsLanguage || b.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + h + g + "\x3c/head\x3e\x3cbody" + (c.bodyId ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
    ...
    (function() {
        function w(d) {
            function f(b) {
                ...
                for (var g = l.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1], k = CKEDITOR.plugins.list.listToArray(b, q), h = k[e.getCustomData("listarray_index")].indent, a = a.getCustomData("listarray_index"); a <= e.getCustomData("listarray_index"); a++)
                    if (k[a].indent += g,
                    0 < g) {
                        var n = k[a].parent;
                        k[a].parent = new CKEDITOR.dom.element(n.getName(),n.getDocument())
                    }
                for (a = e.getCustomData("listarray_index") + 1; a < k.length && k[a].indent > h; a++)
                    k[a].indent += g;
                ...
                if (r && r.length)
                    for (a = 0; a < r.length; a++) {
                        for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName()in p; )
                            CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(c.document.createText(" ")),
                            b.append(m);
                        b.insertAfter(f)
                    }
            ...
            for (var l = this, q = this.database, p = this.context, c, n = d.getSelection(), n = (n && n.getRanges()).createIterator(); c = n.getNextRange(); ) {
                ...
                if (!b) {
                    ...
                    h && h.type == CKEDITOR.NODE_ELEMENT && h.getName()in p && (c.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
                    c.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                    b = h)
                }
                b && c.startContainer.type == CKEDITOR.NODE_ELEMENT && c.startContainer.getName()in p && (h = new CKEDITOR.dom.walker(c),
                h.evaluator = t,
                c.startContainer = h.next());
                b && c.endContainer.type == CKEDITOR.NODE_ELEMENT && c.endContainer.getName()in p && (h = new CKEDITOR.dom.walker(c),
                h.evaluator = t,
                ...
                function f(d) {
                    ...
                    d.on("key", function(f) {
                        ...
                        if ("wysiwyg" == d.mode && f.data.keyCode == this.indentKey && c) {
                            ...
                            !n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, n) || (d.execCommand(this.relatedGlobal),
                            f.cancel())
                        }
                    }, this);
        ...
        CKEDITOR.plugins.list = {
            ...
            arrayToList: function(b, m, e, c, f) {
                ...
                for (var g, k = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(k), d = null, a = e, p = Math.max(b[e].indent, 0), l = null, q, n, t = c == CKEDITOR.ENTER_P ? "p" : "div"; ; ) {
                    ...
                    if (r.indent == p) {
                        d && b[a].parent.getName() == d.getName() || (d = b[a].parent.clone(!1, 1),
                        ...
                        x && ((n || l).append(x),
                        x = null);
                        l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && a != b.length - 1 && (CKEDITOR.env.needsBrFiller && (q = l.getLast()) && q.type == CKEDITOR.NODE_ELEMENT && q.is("br") && q.remove(),
            ...
            exec: function(b) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    if (f.getFirst(u)) {
                        ...
                        m.enterMode == CKEDITOR.ENTER_BR ? f.appendBogus() : c[0].fixBlock(1, m.enterMode == CKEDITOR.ENTER_P ? "p" : "div"),
                        e.selectRanges(c)
                }
                for (var m = e.createBookmarks(!0), f = [], k = {}, c = c.createIterator(), h = 0; (g = c.getNextRange()) && ++h; ) {
                    ...
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; d = g.getNextParagraph(); )
                        if (!d.getCustomData("list_block")) {
                            ...
                            p || (p = l,
                            p.getCustomData("list_group_object_" + h) ? p.getCustomData("list_group_object_" + h).contents.push(d) : (a = {
                                root: p,
                                contents: [d]
                            },
                    ...
                    this.state == CKEDITOR.TRISTATE_OFF)
                        if (v[a.root.getName()]) {
                            ...
                            for (d = 0; d < h.contents.length; d++)
                                ...
                                CKEDITOR.dom.element.setMarker(a, n, "list_item_processed", !0));
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,basicstyles,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,list';
    ...
    (function() {
        ...
        if (CKEDITOR.env.hidpi)
            setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,indent-rtl,168,,indent,192,,outdent-rtl,216,,outdent,240,,bulletedlist-rtl,264,,bulletedlist,288,,numberedlist-rtl,312,,numberedlist,336,', 'icons_hidpi.png');
        else
            setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,indent-rtl,168,auto,indent,192,auto,outdent-rtl,216,auto,outdent,240,auto,bulletedlist-rtl,264,auto,bulletedlist,288,auto,numberedlist-rtl,312,auto,numberedlist,336,auto', 'icons.png');
    }
    )();

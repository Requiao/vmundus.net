...
function sendResetPassEmail($email, $confirmation_hash) {
	...
	$message = '<div style="' . "\n" .
			   ...
			   '"><img alt="vmundus logo" src="https://vmundus.online/img/logo.png" ' . "\n" .
			   ...
			   'href="http://vmundus.online/index?reset_password=' . $confirmation_hash . '">' . "\n" . 
			   'http://vmundus.online/index?reset_password=' . "\r\n" . $confirmation_hash . '</a>' . "\n" .
			   '</div>' . "\n" .
			   ...
			   'href="https://vmundus.online/index?reset_password=' . $confirmation_hash . '">Reset</a></div>' . "\n" .
			   '<p style="font-family: Bell MT, Baskerville Old Face;' . "\n" .
			   ...
			   'contact us by vmundus.online@gmail.com. Thank You!</p>' .
	...
	$from_mail = 'vmundus.online@gmail.com';
	$from_name = 'vMundus';
   ...
   // Mail header
    ...
    $header .= "X-Sender: <mundus@vmundus.online> \r\n";
	$header .= 'X-Mailer: PHP/' . phpversion() . " \r\n";
	$header .= "X-Priority: 1 \r\n"; // Urgent message!
	$header .= "Return-Path: <mundus@vmundus.online \r\n"; // Return path for errors

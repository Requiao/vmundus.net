<?php
	...
	include('/home/u153769202/domains/vmundus.online/public_html/crons/timezone_id.php'); //$timezone_id
	...
	include('/home/u153769202/domains/vmundus.online/public_html/php_functions/record_statistics.php');
	include('/home/u153769202/domains/vmundus.online/public_html//php_functions/delete_person.php');//deletePerson($person_id)
	include('/home/u153769202/domains/vmundus.online/public_html//php_functions/add_new_person.php');//addNewPerson($born_bar, $room, $user_id);

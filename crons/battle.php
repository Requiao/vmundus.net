<?php
	...
	$query = "UPDATE battles SET defender_damage = defender_damage + 10 WHERE defender_id = 1000
			  AND active = TRUE";
	$conn->query($query);

	$query = "UPDATE battles SET attacker_damage = attacker_damage + 10 WHERE attacker_id = 1000
			  AND active = TRUE";
	$conn->query($query);
